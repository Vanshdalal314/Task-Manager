...
export const BUTTON_CLASSES =
    "w-full bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"

// PROFILE CSS
export const INPUT_WRAPPER =
    "flex items-center border border-blue-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition-all duration-200"
export const FULL_BUTTON =
    "w-full bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 text-white py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"
...
export const SIDEBAR_CLASSES = {
    ...
    mobileDrawerBackdrop: "fixed inset-0 bg-white/40 backdrop-blur-sm",
...
export const LINK_CLASSES = {
    ...
    active: "bg-gradient-to-r from-blue-50 to-blue-50 border-l-4 border-blue-500 text-blue-700 font-medium shadow-sm",
...
export const PRODUCTIVITY_CARD = {
    ...
    barFg: "h-full bg-gradient-to-r from-blue-500 to-blue-600 animate-pulse",
}

export const TIP_CARD = {
    container: "bg-gradient-to-r from-blue-50 to-blue-50 rounded-xl p-4 border border-blue-100",
...
export const BUTTONCLASSES =
    "w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2"
...
export const getPriorityColor = (priority) => {
    const colors = {
        ...
        high: "border-blue-800 bg-blue-50/50 text-blue-800",
    }
...
export const ADD_BUTTON =
    "flex items-center gap-2 bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 text-white px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 w-full md:w-auto justify-center text-sm md:text-base"
...
export const EMPTY_STATE = {
    ...
    btn: "px-4 py-2 bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 text-white rounded-lg text-sm font-medium",
}
...
export const TAB_INACTIVE = "text-gray-600 hover:bg-blue-100/50"
...
export const CT_CLASSES = {
    ...
    btnActive: "bg-white text-blue-700 shadow-sm border border-blue-100",
    btnInactive: "text-gray-600 hover:text-blue-700 hover:bg-blue-100/50",
...
export const TI_CLASSES = {
    ...
    progressBarFg: "h-full bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 transition-all duration-300",
