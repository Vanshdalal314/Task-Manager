      ...
      <div className={SIDEBAR_CLASSES.desktop}>
        <div className="p-5 border-b border-blue-100 lg:block hidden">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 flex items-center justify-center text-white font-bold shadow-md">
              {initial}
            </div>
            <div>
              ...
              <p className="text-sm text-blue-500 font-medium flex items-center gap-1">
                <Sparkles className="w-3 h-3" /> Let’s do some tasks!
              </p>
            </div>
          </div>
        </div>
